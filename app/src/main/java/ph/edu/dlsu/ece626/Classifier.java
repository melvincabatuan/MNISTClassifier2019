...
public class Classifier {
    ...
    private static final String MODEL_PATH = "mnist_1.14.0_2019-10-09.tflite"; // 20 epochs
    // private static final String MODEL_PATH = "mnist_1.14.0_2019-10-08.tflite"; // 5 epochs
    // private static final String MODEL_PATH = "mnist_1.14.0_2019-10-08_quant.tflite"; // low accuracy 7 and 9 error
    ...
    private float[] postprocess() {
        ...
        return new float[] {maxIndex, maxProb};
    }
}
